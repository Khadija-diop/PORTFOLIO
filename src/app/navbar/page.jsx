        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="flex space-x-4">
              <Link href="/" className="text-gray-950 hover:bg-[#FF9CB6] hover:text-[#C49FFF] px-3 py-2 rounded-md text-md font-medium">
                Home
              </Link>
              <Link href="/about" className="text-gray-950 hover:bg-[#FF9CB6] hover:text-[#C49FFF] px-3 py-2 rounded-md text-md font-medium">
                About
              </Link>
              <Link href="/contact" className="text-gray-950 hover:bg-[#FF9CB6] hover:text-[#C49FFF] px-3 py-2 rounded-md text-md font-medium">
                Contact
              </Link>
            </div>
          </div>
